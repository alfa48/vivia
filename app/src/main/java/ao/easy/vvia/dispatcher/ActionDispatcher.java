    ...
    public class ActionDispatcher {
        ...
        public ActionDispatcher() {
            ...
            handlers.put("bluetooth", new BluetoothHandler());
            handlers.put("wifi", new WifiHandler());
